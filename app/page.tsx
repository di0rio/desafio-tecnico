    ...
    <div>
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse, var(--color-violet-600) 0%, transparent 70%)",
            filter: "blur(40px)",
          }}
        />
        <div className="relative max-w-6xl mx-auto">
          <div className="max-w-2xl">
            ...
            <h1
              className="font-display text-4xl md:text-5xl font-bold leading-tight mb-5 tracking-tight"
              style={{ color: "var(--color-ink-50)" }}
            >
              Conhecimento técnico
              <br />
              <span style={{ color: "var(--color-violet-400)" }}>
